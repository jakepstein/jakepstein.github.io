...
Another interactive timeline, this shows the chain of events that will go down in Boston history, as well as Red Sox history, a team that turned a city's misery around with a World Series win.
...
Interestingly enough, Arts and Sciences is the biggest college within Lehigh, which makes me wonder why we are always on the end of friendly jokes by Engineers.
...
This graph shows the trend of college enrollment over the last decade, and we can see a noticable decrease in Arts and Sciences enrollment, a slight decrease in Business enrollment, and for the most part, a steady increase in Engineering enrollment.
...
If you want to know some good places to experience some culture, look no further than this map!
...
I love Boston and I love sports; combine them and get Boston sports. This interactive map is a neat way to visualize where the different venues are located are their proximity to eachother (sorry, Gilette Stadium, not sure what you're doing way out there). 
...
An interactive map showing the most popular baby names across the nation by state, for the last century. 
...
A look at the distribution of Summer Olympic medals across the globe, most of the high-achieving countries won't come as a surprise, while there are some extremely tiny countries racking up a few medals to make their names!
